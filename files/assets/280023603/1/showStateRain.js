var ShowStateRain = pc.createScript('showStateRain');

// initialize code called once per entity
ShowStateRain.prototype.initialize = function() {
...
ShowStateRain.prototype.bindClick = function() {
...
ShowStateRain.prototype.handleClick = async function() {
    try {
...
ShowStateRain.prototype.drawSimpleChart = function(data) {
    // グラフモードを更新する
    if (this.chartCanvas) {
...
ShowStateRain.prototype.enableChartClickZoom = function() {
    const tryBind = () => {
...
ShowStateRain.prototype.showZoomedChart = function() {
...
ShowStateRain.prototype.drawZoomedChart = function(data) {
...
ShowStateRain.prototype.convertToChartData = function(data) {
    // 元のデータをグラフ用の形式に変換する
...
ShowStateRain.prototype.drawChartToCanvas = function(canvas, rawData, isZoomed = false) {
    ...
    for (let i = 0; i <= yGridLines; i++) {
        ...
        ctx.font = isZoomed ? '14px Arial' : '12px Arial';
        ctx.textAlign = 'left';
        const rainValue_24h = minRain_24h + (i / yGridLines) * rangeRain_24h;
        ctx.fillText(rainValue_24h.toFixed(1), rightAxisX + (isZoomed ? 20 : 10), y + 4);
    }
    ...
    */
    ...
    ctx.fillText('雨量 (mm) / 1時間累積雨量 (mm)', 0, 0);
    ctx.restore();
...
ShowStateRain.prototype.formatTimeForAxis = function(date) {
...
// イベントリスナーをクリア
ShowStateRain.prototype.onDestroy = function() {
    if (this.entity.button) {
...
ShowStateRain.prototype.fetchDataFromSupabase = async function(startDate, endDate) {
