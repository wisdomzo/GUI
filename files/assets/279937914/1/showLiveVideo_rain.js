var ShowLiveVideoRain = pc.createScript('showLiveVideoRain');

ShowLiveVideoRain.attributes.add('videoUrl', {
    type: 'string', 
    default: 'https://res.cloudinary.com/demo/video/upload/dog.mp4' 
});

// initialize code called once per entity
ShowLiveVideoRain.prototype.initialize = function() {
    ...
    if (this.graph) {
        this.chartCanvas = this.graph.findByName('videoScreen_rain');
    }
    if (!this.chartCanvas) {
...
ShowLiveVideoRain.prototype._applyTexture = function() {
...
ShowLiveVideoRain.prototype.toggle = function() {
...
ShowLiveVideoRain.prototype.update = function(dt) {
    if (this.visible && this.video.readyState >= this.video.HAVE_CURRENT_DATA) {
        this.videoTexture.upload();
    }
};

ShowLiveVideoRain.prototype.enableChartClickZoom = function() {
    if (this.chartCanvas.element) {
        this.chartCanvas.element.on('click', this.openZoomOverlay, this);
    }
};

ShowLiveVideoRain.prototype.openZoomOverlay = function() {
    // 1. 全画面マスクを作成する
...
ShowLiveVideoRain.prototype.destroy = function() {
